...
saver.save(sess, "concat-bidirectional-bahdanau/model.ckpt")
...
freeze_graph("concat-bidirectional-bahdanau", strings)


# In[27]:


g = load_graph("concat-bidirectional-bahdanau/frozen_model.pb")
