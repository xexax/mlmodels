...
saver.save(sess, "concat-bidirectional-luong/model.ckpt")
...
freeze_graph("concat-bidirectional-luong", strings)


# In[27]:


g = load_graph("concat-bidirectional-luong/frozen_model.pb")
