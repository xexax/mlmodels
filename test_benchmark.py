...
def benchmark_run(bench_pars=None, args=None, config_mode="test"):
    ...
    dataset_uri  = args.data_path + f"{args.item_id}"
...
def cli_load_arguments(config_file=None):
    ...
    add("--do",          default="vision_mnist", help="do ")
    ...
    #### Input dataset
    add("--data_path",   default="dataset/vision/", help="Dataset path")
    add("--dataset_name",default="MNIST", help="dataset name")   
