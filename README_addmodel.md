...
0) Look at example :
https://github.com/arita37/mlmodels/blob/dev/mlmodels/model_tch/nbeats.py


0 Create a branch from DEV branch called : feat_XXXXX
...
7) Change this file with your model name :
    https://github.com/arita37/mlmodels/blob/d3e0bce4108255f5d4ff6541b062740b5e4bd6fc/.github/workflows/test_specific_model.yml#L68


7) Commit and check Github Actions
